...
24. PrivExchange by @_dirkjan (Relay of Exchange Machine account via NTLM to AD and perform a privchage to elevate to domain admin) -> priveschange_dirkjan.evtx  
